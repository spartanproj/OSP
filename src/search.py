...
def search_for_packages(args):
    ...
    try:
        ...
        print(Colours.BOLD + Colours.RED + "ERROR: All packages have four categories: extras, experiments, community and themes. Example: osp install extras/marvin-adventures" + Colours.RESET)
        sys.exit()
    try:
